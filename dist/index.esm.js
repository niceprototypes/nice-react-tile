 ...
 */
const ContentMain = ({ title, titleProps, contentCenter, description, descriptionProps, mode, }) => (jsxs(Flex, { direction: "column", gap: descriptionProps.size, children: [title && (jsx(Typography, { as: "h3", weight: "semibold", mode: mode, ...titleProps, children: title })), contentCenter, description && (Array.isArray(description)
...
const TileContent = ({ children, contentTop, contentCenter, title, titleProps, description, descriptionProps, align, mode, gap, }) => {
    ...
    return (jsxs(Flex, { direction: "column", gap: "none", children: [contentTop, hasContentMain && (jsx(ContentMain, { title: title, titleProps: titleProps, contentCenter: contentCenter, description: description, descriptionProps: descriptionProps, mode: mode })), children && (jsx(Flex, { direction: "column", spacing: gap ? `${gap} none none` : undefined, children: children }))] }));
};
